...
<div class="container">
	...
	<div class="text-right">
		<!-- 
			EL의 내장객체인 sessionScope를 통해 세션영역에 저장된 속성이 있는지 확인한다.
			단, 영역에 저장된 속성명이 유일하면 내장객체는 생략할 수 있으므로
			필수사항으로 기술해야 하는 것은 아니다.
		 -->	
		<c:choose>
